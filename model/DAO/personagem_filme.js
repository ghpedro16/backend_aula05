...
const setDeleteCharacterByIdMovies = async function(id_filme){
    try {
        //Script sql
        let sql = `DELETE FROM tbl_personagem_filme WHERE id_filme = ${id_filme}`
